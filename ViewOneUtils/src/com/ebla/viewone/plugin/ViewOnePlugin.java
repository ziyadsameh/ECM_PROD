package com.ebla.viewone.plugin;
 ...
 * <p>
 */
public class ViewOnePlugin extends Plugin {
	...
	public String getConfigurationDijitClass() {
		return "viewOnePluginDojo.ConfigurationPane";
	}
	...
	public PluginResponseFilter[] getResponseFilters() {
		if (pluginResponseFilters.length == 0) {
			pluginResponseFilters = new PluginResponseFilter[] {new com.ebla.viewone.plugin.filters.ViewerResponseFilter()};
		}
